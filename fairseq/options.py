...
def add_checkpoint_args(parser):
    ...
    # for DA KD
    group.add_argument('--restore-teacher-file', default='checkpoint_teacher_last.pt')
    group.add_argument('--knowledge-distillation', action='store_true')
    group.add_argument('--mask-file', type=str, default=None,
                    help='The absolute path to the mask file.')
