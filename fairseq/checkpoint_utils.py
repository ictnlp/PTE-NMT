...
def load_checkpoint(args, trainer):
    ...
    if os.path.isabs(args.restore_file):
        ...
        #DA KD
        checkpoint_teacher_path = os.path.join(args.save_dir, args.restore_teacher_file)
    ...
    extra_state_teacher = trainer.load_checkpoint(
        checkpoint_teacher_path,
        args.reset_optimizer,
        args.reset_lr_scheduler,
        eval(args.optimizer_overrides),
        reset_meters=args.reset_meters,
    ...
    return extra_state, extra_state_teacher, epoch_itr
