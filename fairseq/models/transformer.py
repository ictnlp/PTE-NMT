...
@register_model_architecture('transformer', 'transformer_small_da_zh_en')
def transformer_small_da_zh_en(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 1024)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 4)
...
@register_model_architecture('transformer', 'transformer_tiny_da_zh_en')
def transformer_tiny_da_zh_en(args):
